...
vi.mock('@/features/database/detail/dbDetailRegistry', async () => {
  const actual = await vi.importActual<
    typeof import('@/features/database/detail/dbDetailRegistry')
  >('@/features/database/detail/dbDetailRegistry')
...
describe('BuilderPage awakener basics', () => {
  it('uses icon-only empty placeholders without helper text', async () => {
    ...
    try {
      ...
      await screen.findByRole('button', {name: /goliath/i})
  ...
  it('renders an overlay modal from a picker awakener detail action on builder', async () => {
    render(<BuilderPage />)
