...
function buildTabClassName(active: boolean) {
  const base =
    'database-entity-tab -mb-px inline-flex min-h-11 items-center justify-center border-b-2 px-3 pb-2 pt-2 text-sm font-semibold tracking-[0.03em] transition-colors focus-visible:outline-none sm:min-h-10 sm:justify-start sm:px-3.5 sm:text-base sm:tracking-[0.02em]'
  return active
