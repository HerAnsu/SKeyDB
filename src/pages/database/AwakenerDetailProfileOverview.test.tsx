...
const TEST_FULL_DATA = makeTestAwakenerFullV2Record({
  id: 2,
  displayName: 'Agrippa',
  profile: {
    title: 'Agrippa',
...
const TEST_FULL_DATA_WITH_PROFILE_FACTION = makeTestAwakenerFullV2Record({
  ...TEST_FULL_DATA,
  profile: {
  ...
  it('uses the profile faction and places it after gnostic index', () => {
    const {container} = render(
      <AwakenerDetailOverview
        awakener={TEST_AWAKENER}
        fontScale='medium'
        fullDataV2={TEST_FULL_DATA_WITH_PROFILE_FACTION}
        scalingRecord={TEST_SCALING_RECORD}
        stats={TEST_STATS}
        substatScaling={TEST_SUBSTAT_SCALING}
      />,
