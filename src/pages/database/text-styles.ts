...
export const DATABASE_ITEM_NAME_CLASS = 'font-semibold text-amber-200/90'
export const DATABASE_ENTRY_TITLE_CLASS = 'text-base font-semibold tracking-wide text-amber-200/90'
...
export const DATABASE_SCALING_TOKEN_CLASS =
  'db-dash-underline db-dash-underline-hover cursor-help text-amber-100/85 [--db-dash-strength:24%] [--db-dash-hover-strength:36%] hover:text-amber-50 outline-none'
