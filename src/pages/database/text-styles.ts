...
export const DATABASE_INTERACTIVE_TOKEN_CLASS =
  'cursor-pointer border-b border-dotted border-current/35 text-amber-100/85 transition-colors hover:border-current/60 hover:text-amber-50 outline-none'
...
export const DATABASE_SCALING_TOKEN_CLASS =
  'cursor-help border-b border-dotted border-current/35 text-amber-100/85 transition-colors hover:border-current/60 hover:text-amber-50 outline-none'
