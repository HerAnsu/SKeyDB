...
const chipSurfaceClass =
  'h-10 rounded-[2px] border border-slate-700/70 bg-[linear-gradient(180deg,rgba(13,20,34,0.9),rgba(8,13,24,0.84))] px-2.5 text-[11px] leading-none text-slate-200 outline-none transition-colors hover:border-slate-500/70 focus:border-amber-300/60 focus-visible:border-amber-300/60 sm:h-8'
