...
import {changelogItems} from '@/pages/home/changelog';
    ...
    <section className='space-y-4'>
      <header className='flex flex-wrap items-center gap-3 border border-amber-200/35 bg-slate-900/40 p-4 shadow-[0_0_0_1px_rgba(251,191,36,0.08)]'>
        ...
        <div className='min-w-0'>
          <div className='space-y-1 text-sm text-slate-300'>
            ...
            <p>
              Hello friends, I am just a guy.. and old.. and running out of
              codex credits.. but I have a lot of free time ~
            </p>
            <p>
              I am trying to make something useful for the community with the
              help of a few people over in Mythag University!
            </p>
            <a
            ...
            <ul className='space-y-1 pt-1'>
              ...
              <li className='text-slate-400'>
                DMs open for questions, issues, angry messages, and mild
      ...
      <div className='grid gap-4 md:grid-cols-2'>
        <HomeFeatureItem
          ...
          icon={FaDiscord} // Added a placeholder icon
        />
        <HomeFeatureItem
          ...
          icon={FaGithub} // Added a placeholder icon
        />
      </div>

      <div className='grid gap-4 lg:grid-cols-3'>
        <HomeTechItem items={builderTasks} title='Builder Tracker' />
        <HomeTechItem items={databaseTasks} title='Database Tracker' />
        <HomeTechItem items={resourceTasks} title='Resources Tracker' />
      </div>
      ...
      <article className='border border-slate-500/45 bg-slate-900/55 p-4'>
        ...
        {changelogItems.length > 5 ? (
          <button
            ...
            onClick={() => {
              setShowAllChangelog((current) => !current);
            }}
            type='button'
          >
      ...
      <article className='border border-slate-500/45 bg-slate-900/55 p-4'>
        ...
        <ul className='mt-2 space-y-2 text-sm text-slate-200'>
          <li>
            Awakener avatars/cards and posse images used in this project are
          ...
          <li>
            Big thanks to the Huiji contributors for putting those resources
            together, it helped us get going a lot quicker than we would have
            otherwise
          </li>
          <li>
          ...
          <li>
            SKeyDB is an unofficial fan project and is not affiliated with
            Qookka Games.
          </li>
          <li>
            Morimens names, images, icons, and related game assets belong to
            Qookka Games and/or their licensors.
          </li>
          <li>
            If you are a rights holder and want anything adjusted or removed,
            please reach out.
          </li>
        </ul>
      </article>
  ...
  return (
    <article className='border border-amber-200/35 bg-slate-900/40 p-4 shadow-[0_0_0_1px_rgba(251,191,36,0.08)]'>
      <div className='flex items-center gap-3'>
        <Icon className='text-2xl text-amber-100' />
...
function HomeTechItem({
  title,
  items,
}: Readonly<{title: string; items: TaskItem[]}>) {
  return (
    <article className='border border-slate-500/45 bg-slate-900/55 p-4'>
      <h3 className='ui-title text-lg text-amber-100'>{title}</h3>
      <ul className='mt-2 space-y-2 text-sm text-slate-200'>
