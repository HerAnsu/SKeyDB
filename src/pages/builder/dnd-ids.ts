...
export function makeWheelDropZoneId(
  slotId: string,
  wheelIndex: number,
): string {
...
export function parseWheelDropZoneId(
  id: string,
): {slotId: string; wheelIndex: number} | null {
...
export function makeTeamPreviewSlotDropZoneId(
  teamId: string,
  slotId: string,
): string {
