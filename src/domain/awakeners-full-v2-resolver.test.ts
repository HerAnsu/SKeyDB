...
describe('awakeners-full-v2-resolver', () => {
  ...
  it('applies base talent patches and gates soulforge talent patches by soulforge level', () => {
    const disabledSoulforge = resolveAwakenerFullV2Record(buildRecord(), {
      soulforgeLevel: 0,
    })
    const enabledSoulforge = resolveAwakenerFullV2Record(buildRecord(), {
      soulforgeLevel: 2,
    })
  ...
  it('keeps soulforge aptitude visible even when its effects are disabled', () => {
    const resolved = resolveAwakenerFullV2Record(buildRecord(), {
      soulforgeLevel: 0,
    })
  ...
  it('applies real cumulative skill patches from public V2 enlightens', async () => {
    ...
    const resolved = resolveAwakenerFullV2Record(thais, {
      selectedEnlightenSlot: 'E3',
    })
