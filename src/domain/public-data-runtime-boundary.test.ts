...
describe('public data runtime boundary', () => {
  ...
  it('does not add retired public-data runtime detail adapters', () => {
  ...
  it('does not keep retired runtime detail module names or symbols', () => {
