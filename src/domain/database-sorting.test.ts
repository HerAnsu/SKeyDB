...
describe('compareAwakenersForDatabaseSort', () => {
  it('groups by realm without losing the selected stat order inside each realm', () => {
    const awakeners = [
      ...
      makeAwakener({ id: 2, name: 'Aequor High', realm: 'AEQUOR', stats: { CON: 100, ATK: 90, DEF: 50 } }),
      makeAwakener({ id: 3, name: 'Chaos High', realm: 'CHAOS', stats: { CON: 100, ATK: 80, DEF: 50 } }),
      makeAwakener({ id: 4, name: 'Aequor Low', realm: 'AEQUOR', stats: { CON: 100, ATK: 20, DEF: 50 } }),
    ]
